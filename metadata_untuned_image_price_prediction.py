...
#Note: Just created a placeholder for image_data which is currently non-existent. Once it is created, comment out this line
...
model.compile(optimizer='rmsprop', loss='mean_absolute_percentage_error',metrics=['mean_absolute_error', 'mse'])
